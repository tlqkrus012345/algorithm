...
/**
 * 힙정렬
 * 최대 힙 트리(오름차순)나 최소 힙 트리(내림차순)를 구성해 정렬을 한다
 * n개의 노드에 대한 완전 이진 트리를 구성한다(각각의 노드가 최대 두 개의 자식 노드를 가지는)
 * 최대 힙을 구성하고 가장 큰 수를 가장 작은 수와 교환하다.
 * 시간복잡도는 O(nlogn)
 *
 * ex) 최대 힙 80         최소 힙 19
 *         60    47          35    47
 *       44 35  19         44 60  80
 * arr[80,60,47,44,35,19]  arr[19,35,47,44,60,80]
